...
func (x *QueryUsersOnlineReq) GetAppID() string {
	if x != nil {
		return x.AppID
	}
	return ""
...
type SendMsgReq struct {
	...
	AppID   string `protobuf:"bytes,2,opt,name=appID,proto3" json:"appID,omitempty"`      // appID/房间ID
...
func (x *GetUserListReq) GetAppID() string {
	if x != nil {
		return x.AppID
	}
	return ""
...
var file_im_protobuf_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x44, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x44, 0x12, 0x16, 0x0a, 0x06,
